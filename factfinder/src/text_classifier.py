"""Classifier of citizens' messages by city function."""
...
class TextClassifier(BaseTextClassifier):
    """Classify text into the city-function categories used by SOIKA."""

    DEFAULT_REPOSITORY_ID = "Sandrro/text_to_function_v2"
